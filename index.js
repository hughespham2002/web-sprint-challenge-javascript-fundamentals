...
// It is because it is a closure since nestedFunction is reaching outside its scope for the internal variable
...
const zooAnimals = [
  ...
  */
  ...
  console.log('req 1', animalNames(zooAnimals))
  ...
  */
  ...
  function lowerCaseNames(array){
    return array.map(function (array) { 
      const newArr = array.animal_name;
      return newArr.toLowerCase();});
  } 
  console.log(`req 2`, lowerCaseNames(zooAnimals))
  ...
  */
  ...
  function USApop(arr){
    const totalPop = arr.reduce((counter, item) => {
